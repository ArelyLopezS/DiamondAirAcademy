...
<body>
    ...
    <div id="iniciarsesion">
        ...
        <?php
                // Agregar enlace para cuenta exlusiva
                echo "<p>Ingresa a tu cuenta exclusiva para las Estudiantes de la Academia.</p><p>¡Una gran aventura te guarda!</p>";
...
if ($resultados) {
    ...
    if ($usuario && password_verify($contrasena, $usuario['contrasena'])) {
        ...
        // Almacenar ID del alumno en la sesión
        session_start();
    ...
    echo "<p>Error en la consulta: " . $conexion->error . "</p>";
        ...
        echo "<p>¿Eres Administrador? <a href='loginadmin.php'><br>¡Ingresa Aquí!</a></p>";
        ?>
    </div>
